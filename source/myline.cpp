...
void MyLine::set(float x1, float y1, float x2, float y2, float Width, int num)
{
	this->Width = Width;
...
void MyLine::SetRotable(bool f1, int f2)
{
	Rotable = f1;
	rotMode = f2;
...
void MyLine::SetBad(bool f)
{
	Bad = f;

}

void MyLine::SetLift(bool f)
{
	Lift = f;
}

void MyLine::Rotate(float angle)
{
	return;
	//  PointF rotPnt;
...
void MyLine::ShowShadow(bool flag, PointF* light, float* onlgt)
{
	//	 doff
